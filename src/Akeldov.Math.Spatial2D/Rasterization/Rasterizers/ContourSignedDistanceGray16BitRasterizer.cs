...
namespace Akeldov.Math.Spatial2D.Rasterization
{
    ...
    public sealed class ContourSignedDistanceGray16BitRasterizer : IRasterizer<IContour, Gray16BitRaster>
    {
        ...
        /// </summary>
        /// <param name="signedDistanceToGrayLevel">The function that maps signed distance to the contour to a 16-bit grayscale value. Negative distances are inside the contour; positive distances are outside.</param>
        public ContourSignedDistanceGray16BitRasterizer(Func<float, ushort> signedDistanceToGrayLevel)
        {
