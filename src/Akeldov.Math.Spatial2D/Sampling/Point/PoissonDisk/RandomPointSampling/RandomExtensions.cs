...
namespace Akeldov.Math.Spatial2D.Sampling.Point.PoissonDisk
{
    internal static partial class RandomExtensions
    {
        ...
        public static VectorXY SelectRandomAroundPoint(this Random rnd, VectorXY point, float minimalDistance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static VectorXY SelectRandomPoint(this Random rnd, VectorXY fieldSize)
        {
