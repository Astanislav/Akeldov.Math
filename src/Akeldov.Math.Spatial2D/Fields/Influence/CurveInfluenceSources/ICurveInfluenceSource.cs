...
{
    /// <summary>
    /// Represents an influence source backed by a projectable curve.
    /// </summary>
    /// <remarks>
    /// Curve influence sources can measure distance, intersect rays, and project sampled points onto
    /// the underlying curve.
    /// </remarks>
    public interface ICurveInfluenceSource : IInfluenceSource, IProjectableCurve
    {
    }

    /// <summary>
    /// Represents a typed influence source backed by a projectable curve.
    /// </summary>
